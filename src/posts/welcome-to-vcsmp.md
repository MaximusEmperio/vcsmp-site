...
| | |
|---|---|
| **Server IP** | `play.vcsmp.com` |
| **Edition** | Java (recommended) or Bedrock |
...
## How do I keep my builds safe?

Unlike previous iterations of VCSMP, we made a deliberate decision *not* to include a plugin that lets players "claim" regions of the server (like Factions or Towny). We feel that claiming plugins detract from the vanilla experience, stifle build freedom, and add unnecessary complexity.

Regardless, **griefing is strictly banned**. Because we run server-side plugins like CoreProtect, griefers *will* be caught, and your builds and belongings will be seamlessly rolled back. Your hard work is safe, so build without fear!
...
> **Have a suggestion?** We're always taking recommendations for new datapacks and plugins! Just let us know.

## How big is the world?

We have spent considerable time thinking about lag and performance. Because of this, we have pre-generated a **20,000 x 20,000 block region** around spawn and have imposed a world border to keep players within this area.
